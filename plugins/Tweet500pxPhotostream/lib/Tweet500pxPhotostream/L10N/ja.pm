package Tweet500pxPhotostream::L10N::ja;
use strict;
use base qw( Tweet500pxPhotostream::L10N MT::L10N MT::Plugin::L10N );
use vars qw( %Lexicon );

our %Lexicon = (
    'Available Tweet500pxPhotostream.' => 'タスク実行によって自動的に 500px の photostream をツイートします。',
    'Tweet500pxPhotostream Task' => 'Tweet500pxPhotostream のタスク',
    ...
    'Settings for 500px' => '500px に関する設定',
    '500px ID' => '500px の ID',
